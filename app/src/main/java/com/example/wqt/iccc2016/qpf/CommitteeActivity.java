...
<<<<<<< HEAD
    ...
    private void initCommittee() {
        ...
        Committee wei_zhang = new Committee(R.drawable.wei_zhang, getResources().getString(R.string.committee_wei_zhang), "Australia");
        mList.add(wei_zhang);
        Committee meixia_tao = new Committee(R.drawable.meixia_tao, getResources().getString(R.string.committee_meixia_tao), "China");
        mList.add(meixia_tao);
        Committee hongfang_yu = new Committee(R.drawable.hongfang_yu, getResources().getString(R.string.committee_hongfang_yu), "China");
        mList.add(hongfang_yu);
        Committee kun_yang = new Committee(R.drawable.kun_yang, getResources().getString(R.string.committee_kun_yang), "UK");
        mList.add(kun_yang);
        Committee shui_yu = new Committee(R.drawable.shui_yu, getResources().getString(R.string.committee_shui_yu), "Australia");
        mList.add(shui_yu);
        Committee kun_wang = new Committee(R.drawable.kun_wang, getResources().getString(R.string.committee_kun_wang), "China");
        mList.add(kun_wang);
        Committee bin_ma = new Committee(R.drawable.bin_ma, getResources().getString(R.string.committee_bin_ma), "China");
        mList.add(bin_ma);
        Committee bruce_worthman = new Committee(R.drawable.bruce_worthman, getResources().getString(R.string.committee_bruce), "USA");
        mList.add(bruce_worthman);
        Committee bo_yan = new Committee(R.drawable.bo_yan, getResources().getString(R.string.committee_bo_yan), "China");
        mList.add(bo_yan);
        Committee xiaoyan_huang = new Committee(R.drawable.xiaoyang_huang, getResources().getString(R.string.committee_xiaoyan_huang), "China");
        mList.add(xiaoyan_huang);
        Committee rongping_lin = new Committee(R.drawable.rongping_lin, getResources().getString(R.string.committee_rongping_lin), "China");
        mList.add(rongping_lin);
        Committee jingran_lin = new Committee(R.drawable.jingran_lin, getResources().getString(R.string.committee_jingran_lin), "China");
        mList.add(jingran_lin);
        Committee yue_cao = new Committee(R.drawable.yue_cao, getResources().getString(R.string.committee_yue_cao), "UK");
        mList.add(yue_cao);
        Committee geyong_min = new Committee(R.drawable.geyong_min, getResources().getString(R.string.committee_geyong_min), "UK");
        mList.add(geyong_min);
        Committee sumei_sun = new Committee(R.drawable.sumei_sun, getResources().getString(R.string.committee_sumei_sun), "Singapore");
        mList.add(sumei_sun);
        Committee xuming_fang = new Committee(R.drawable.xuming, getResources().getString(R.string.committee_xuming_fang), "China");
        mList.add(xuming_fang);
        Committee gang_wu = new Committee(R.drawable.gang_wu, getResources().getString(R.string.committee_gang_wu), "China");
        mList.add(gang_wu);
        Committee pingyi_fan = new Committee(R.drawable.pingyi_fan, getResources().getString(R.string.committee_pingyi_fan), "China");
        mList.add(pingyi_fan);
        Committee guodong_zhao = new Committee(R.drawable.guodong_zhao, getResources().getString(R.string.committee_guodong_zhao), "China");
        mList.add(guodong_zhao);
        Committee fan_wu = new Committee(R.drawable.fan_wu, getResources().getString(R.string.committee_fan_wu), "China");
        mList.add(fan_wu);
        Committee yunkai_wei = new Committee(R.drawable.yunkai_wei, getResources().getString(R.string.committee_yunkai_wei), "China");
        mList.add(yunkai_wei);
        Committee xuemin_shen = new Committee(R.drawable.xuemin_shen, getResources().getString(R.string.committee_xuemin_shen), "Canada");
        mList.add(xuemin_shen);
        Committee ke_gong = new Committee(R.drawable.ke_gong, getResources().getString(R.string.committee_ke_gong), "China");
        mList.add(ke_gong);
        Committee zhen_yang = new Committee(R.drawable.zhen_yang, getResources().getString(R.string.committee_zhen_yang), "China");
        mList.add(zhen_yang);
        Committee khaled = new Committee(R.drawable.khaled, getResources().getString(R.string.committee_khaled), "ComSoc VIP");
        mList.add(khaled);
        Committee kwang = new Committee(R.drawable.kwang, getResources().getString(R.string.committee_kwang), "Taiwan,China");
        mList.add(kwang);
        Committee steve = new Committee(R.drawable.steve, getResources().getString(R.string.committee_steve), "USA");
        mList.add(steve);
        Committee tong_song = new Committee(R.drawable.tong_song, getResources().getString(R.string.committee_tong_song), "China");
        mList.add(tong_song);
        Committee yinghai_zhang = new Committee(R.drawable.yinghai_zhang, getResources().getString(R.string.committee_yinghai_zhang), "China");
        mList.add(yinghai_zhang);
        Committee zhisheng_niu = new Committee(R.drawable.zhisheng_niu, getResources().getString(R.string.committee_zhisheng_niu), "China");
